...
function Biography() {
  return (
    <div className="relative mt-20 min-h-[100vh] w-screen md:mt-[150px] py-[50px] lg:py-[100px] flex flex-col items-center px-2 md:px-[20px] lg:px-8 xl:px-12 2xl:px-24">
      <div
